...
int nomp_api_242_aux(TEST_TYPE *a, TEST_TYPE *b, TEST_TYPE *c, int N) {
  const char *KNL_FMT =
...
#define nomp_api_242 TOKEN_PASTE(nomp_api_242, TEST_SUFFIX)
int nomp_api_242(int argc, const char *argv[]) {

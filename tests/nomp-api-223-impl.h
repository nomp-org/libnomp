...
#define nomp_api_223_aux TOKEN_PASTE(nomp_api_223_aux, TEST_SUFFIX)
int nomp_api_223_aux(TEST_TYPE *a, TEST_TYPE *b, int N) {
  const char *knl_fmt =
...
#define nomp_api_223 TOKEN_PASTE(nomp_api_223, TEST_SUFFIX)
int nomp_api_223() {
  int n = 10;
  TEST_TYPE a[10], b[10];

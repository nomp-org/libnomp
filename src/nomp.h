...
#define NOMP_INSTALL_DIR_NOT_FOUND -96
#define NOMP_USER_CALLBACK_NOT_FOUND -97
#define NOMP_USER_CALLBACK_FAILURE -98
#define NOMP_C_TO_LOOPY_CONVERSION_ERROR -99
#define NOMP_CODEGEN_FAILED -100
